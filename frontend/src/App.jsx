...
import InvestmentRoom from "./components/Investment Room/InvestmentRoom";
import FounderProfile from "./components/auth/Signup/FounderSignup/FounderProfile";
// import FounderProfileimport from "./components/auth/Signup/FounderSignup/FounderProfile";
    ...
    <div>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/welcome/createfounderprofile" element={<FounderProfile />} />
          ...
          <Route path="/investment" element={<InvestmentRoom />} />
