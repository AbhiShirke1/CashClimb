    ...
    <>
      <section className="bg-white py-20 flex justify-center items-center">
        <div className="features max-w-7xl pb-0">
          <h2 className="text-center items-center mb-4  font-[Nunito,sans-serif]  text-5xl leading-58 font-black">
            Why is fundraising so hard ?
          </h2>
          <div className="idea  text-left  border-b-0  font-[Nunito,sans-serif] flex justify-center items-center font-normal">
            <FcIdea />
                ...
                data.map((items) => (
                  <div key={items.id} className="flex flex-col "> 
                    <div className="feature-item bg-[#6952ff] px-4 py-6 items-center rounded-md w-[300px] h-[250px]">
                      ...
                      <h3 className="text-center font-[Nunito,sans-serif] text-white mb-6 text-3xl font-extrabold pt-2">
                        {items.name}
                      </h3>
                      <h3 className="text-center text-white text-lg font-light font-[Nunito,sans-serif]">
                        {items.text}
                      </h3>
                    </div>
                    <div className="bg-[#f23d61] mt-2 text-base font-medium text-center pt-2 pb-2 flex justify-center items-center space-x-2 rounded-md">
                      ...
                      <p className='text-white font-[Nunito,sans-serif] font-normal'>{items.warning}</p>
                    </div>
                  </div>
                ))
              }
