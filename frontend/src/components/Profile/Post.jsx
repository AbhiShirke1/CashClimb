...
const desc = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus error adipisci, repudiandae consequatur molestias quia! Autem suscipit quod, animi nulla veritatis aut deserunt, laborum nisi quam corrupti expedita adipisci aliquam?";
    ...
    <main className="flex w-full sticky top-0 h-full min-h-screen flex-col ml-6">
      <div className="flex justify-start ml-10 mt-10 items-center m-2">
        ...
        (
          <div className="flex flex-col m-2">
            <form action="">
              <div className="flex flex-col">
                <textarea type="text" name="desc" placeholder="Describe your Post" 
                className="shadow-xl focus:outline-none p-2 font-semibold h-[100px] w-[500px]"/><br />
              </div>
              
              <div className="flex justify-between">
              <label htmlFor="file-upload" className="inline-block bg-black hover:bg-blue-200 text-white font-bold py-2 px-2 rounded">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline-block mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                </svg>
              </label>
              <input id="file-upload" type="file" className="hidden" />
              <button className="bg-[#1f1f1f] p-2 text-white rounded-md" onClick={handleSubmit}>Submit</button>
              </div>
          ...
          <div>
            <button className="bg-black w-[150px] h-10 text-white rounded-md flex items-center"
          ...
          <div key={i} className="p-4 flex space-x-4 ">
            <div className=" w-[650px]  h-[650px] rounded-md shadow-xl">
              <div className="flex flex-row items-center justify-between">
                ...
                <span className="m-4 text-sm font-semibold text-[#575757]">16 hrs ago</span>
              </div>
