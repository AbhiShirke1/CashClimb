    ...
    <>
      ...
      <div className="flex items-center justify-center h-screen font-montserrat">
        <div className="w-[50%] flex flex-col items-center">
          <h1 className="text-[60px] font-semibold ">Sign Up</h1>
          <div className="max-w-[400px]  pt-[30px] ">
            ...
            >
              ...
              <p>Already Signed? <Link to='/login' className="underline text-[#194fffdd]">Login</Link> </p>
