  ...
  return (
    <>
      ...
      - Can contain special characters`,
            ...
            <p className="text-base flex justify-center items-center font-normal text-gray-500">
              Already Signed? <Link to='/login' className="underline text-[#194fffdd]">Login</Link> 
            </p>
        ...
        <div className='bg-[#050029] w-[50%] h-full'>
          ...
          <img
            src={myImg}
            className="w-full h-[70%] rounded-md mt-20"
          />
        </div>
