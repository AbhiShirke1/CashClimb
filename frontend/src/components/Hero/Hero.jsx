                    ...
                    <div class="conatiner w-full">
                              <div class="vision flex justify-center items-center ">
                                        <div class="left w-1/2 pl-[200px]">
                                                  <h1 class="text-white font-Montserrat font-sans font-bold text-[72px] leading-[80px]">
                                                            Simple
                                                            <br/>
                                                            Startup Fundraising
                                                  </h1>
                                                  <p class="text-white text-left text-base leading-6 max-w-xl pt-5">
                                                            Only 1% of startups successfully raise their early stage investment. How can you be in that 1%?
                                                  </p>
                                                  <button class="bg-[#6952ff] text-white mt-5 w-28 h-10  font-Montserrat font-sans text-base rounded-md font-medium leading-5">Signup</button>
